    ...
    for (let n = 1; n < e.length; n += 1) {
        ...
        if (null != a && (i = a, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
            ...
            for (let s = 0, i = e.length; s < i; s += 1) {
                ...
                void 0 !== n && n.enumerable && (f(t[i]) && f(a[i]) ? a[i].__swiper__ ? t[i] = a[i] : m(t[i], a[i]) : !f(t[i]) && f(a[i]) ? (t[i] = {}, a[i].__swiper__ ? t[i] = a[i] : m(t[i], a[i])) : t[i] = a[i])
            }
        }
    }
    var i;
...
function x(e) {
    ...
    if (l.noSwiping && (m ? function(e, t = this) {
            return function t(s) {
                return s && s !== i() && s !== a() ? (s.assignedSlot && (s = s.assignedSlot), s.closest(e) || t(s.getRootNode().host)) : null
            }(t)
    ...
    if (Object.assign(r, {
        ...
        let e = !0;
        h.is(r.focusableElements) && (e = !1), s.activeElement && d(s.activeElement).is(r.focusableElements) && s.activeElement !== h[0] && s.activeElement.blur();
...
function M(e) {
    ...
    if (n.isTouchEvent && a.touchReleaseOnEdges && !a.loop)
        if (s.isVertical()) {
            if (f < r.startY && s.translate <= s.maxTranslate() || f > r.startY && s.translate >= s.minTranslate()) return n.isTouched = !1, void(n.isMoved = !1)
    ...
    if (void 0 === n.isScrolling) {
        let e;
        s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? n.isScrolling = !1 : m * m + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI, n.isScrolling = s.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle)
    }
    if (n.isScrolling && s.emit("touchMoveOpposite", c), void 0 === n.startMoving && (r.currentX === r.startX && r.currentY === r.startY || (n.startMoving = !0)), n.isScrolling) return void(n.isTouched = !1);
    ...
    let w = !0,
        b = a.resistanceRatio;
    if (a.touchReleaseOnEdges && (b = 0), v > 0 && n.currentTranslate > s.minTranslate() ? (w = !1, a.resistance && (n.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + n.startTranslate + v) ** b)) : v < 0 && n.currentTranslate < s.maxTranslate() && (w = !1, a.resistance && (n.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - n.startTranslate - v) ** b)), w && (c.preventedByNestedSwiper = !0), !s.allowSlideNext && "next" === s.swipeDirection && n.currentTranslate < n.startTranslate && (n.currentTranslate = n.startTranslate), !s.allowSlidePrev && "prev" === s.swipeDirection && n.currentTranslate > n.startTranslate && (n.currentTranslate = n.startTranslate), s.allowSlidePrev || s.allowSlideNext || (n.currentTranslate = n.startTranslate), a.threshold > 0) {
...
function $(e) {
    ...
    for (let p = 0; p < r.length; p += p < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
        const e = p < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
        void 0 !== r[p + e] ? h >= r[p] && h < r[p + e] && (f = p, m = r[p + e] - r[p]) : h >= r[p] && (f = p, m = r[r.length - 1] - r[r.length - 2])
    }
    const g = (h - r[f]) / m,
    ...
    if (c > i.longSwipesMs) {
        ...
        t.navigation && (o.target === t.navigation.nextEl || o.target === t.navigation.prevEl) ? o.target === t.navigation.nextEl ? t.slideTo(f + v) : t.slideTo(f) : ("next" === t.swipeDirection && t.slideTo(f + v), "prev" === t.swipeDirection && t.slideTo(f))
    }
}
...
const A = (e, t) => {
    ...
    (n.preventClicks || n.preventClicksPropagation) && r[p]("click", e.onClick, !0), n.cssMode && l[p]("scroll", e.onScroll), n.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", k, !0) : e[u]("observerUpdate", k, !0)
};
...
const B = {
        ...
        update: {
            ...
            updateSlides: function() {
                ...
                for (let g = 0; g < p; g += 1) {
                    x = 0;
                    const n = c.eq(g);
                    if (E && e.grid.updateSlide(g, n, p, t), "none" !== n.css("display")) {
                        ...
                        } else x = (a - (i.slidesPerView - 1) * C) / i.slidesPerView, i.roundLengths && (x = Math.floor(x)), c[g] && (c[g].style[t("width")] = `${x}px`);
                        c[g] && (c[g].swiperSlideSize = x), f.push(x), i.centeredSlides ? (T = T + x / 2 + S / 2 + C, 0 === S && 0 !== g && (T = T - a / 2 - C), 0 === g && (T = T - a / 2 - C), Math.abs(T) < .001 && (T = 0), i.roundLengths && (T = Math.floor(T)), y % i.slidesPerGroup == 0 && u.push(T), h.push(T)) : (i.roundLengths && (T = Math.floor(T)), (y - Math.min(e.params.slidesPerGroupSkip, y)) % e.params.slidesPerGroup == 0 && u.push(T), h.push(T), T = T + x + C), e.virtualSize += x + C, S = x, y += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, a) + v, r && l && ("slide" === i.effect || "coverflow" === i.effect) && n.css({
                ...
                p !== d && e.emit("slidesLengthChange"), u.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== b && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset()
            },
        ...
        transition: {
            ...
            transitionStart: function(e = !0, t) {
                ...
                i.cssMode || (i.autoHeight && s.updateAutoHeight(), E({
                    swiper: s,
                    runCallbacks: e,
                    direction: t,
                    step: "Start"
            ...
            transitionEnd: function(e = !0, t) {
                ...
                s.animating = !1, i.cssMode || (s.setTransition(0), E({
                    swiper: s,
                    runCallbacks: e,
                    direction: t,
                    step: "End"
        ...
        slide: {
            slideTo: function(e = 0, t = this.params.speed, s = !0, i, n) {
                ...
                if (a.updateProgress(w), l.normalizeSlideIndex)
                    for (let v = 0; v < d.length; v += 1) {
                        ...
                        void 0 !== d[v + 1] ? e >= t && e < s - (s - t) / 2 ? r = v : e >= t && e < s && (r = v + 1) : e >= t && (r = v)
                    }
                if (a.initialized && r !== p) {
                    if (!a.allowSlideNext && w < a.translate && w < a.minTranslate()) return !1;
                    if (!a.allowSlidePrev && w > a.translate && w > a.maxTranslate() && (p || 0) !== r) return !1
                }
                let b;
                if (b = r > p ? "next" : r < p ? "prev" : "reset", u && -w === a.translate || !u && w === a.translate) return a.updateActiveIndex(r), l.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== l.effect && a.setTranslate(w), "reset" !== b && (a.transitionStart(s, b), a.transitionEnd(s, b)), !1;
                if (l.cssMode) {
                    const e = a.isHorizontal(),
                        s = u ? w : -w;
                    if (0 === t) {
            ...
            slideToClickedSlide: function() {
                ...
                if (t.loop) {
                    ...
                    n = parseInt(d(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? a < e.loopedSlides - i / 2 || a > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), a = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), p((() => {
                        e.slideTo(a)
                    }))) : e.slideTo(a) : a > e.slides.length - i ? (e.loopFix(), a = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), p((() => {
                        e.slideTo(a)
                    }))) : e.slideTo(a)
                } else e.slideTo(a)
            }
        ...
        loop: {
            loopCreate: function() {
                ...
                for (let i = 0; i < o.length; i += 1) a.append(d(o[i].cloneNode(!0)).addClass(s.slideDuplicateClass));
                for (let i = l.length - 1; i >= 0; i -= 1) a.prepend(d(l[i].cloneNode(!0)).addClass(s.slideDuplicateClass))
            },
            loopFix: function() {
                const e = this;
        ...
        events: {
            attachEvents: function() {
                ...
                e.onTouchStart = x.bind(e), e.onTouchMove = M.bind(e), e.onTouchEnd = $.bind(e), s.cssMode && (e.onScroll = L.bind(e)), e.onClick = P.bind(e), n.touch && !O && (t.addEventListener("touchstart", I), O = !0), A(e, "on")
            },
        ...
        images: {
            loadImage: function(e, t, s, i, n, r) {
                ...
                d(e).parent("picture")[0] || e.complete && n ? c() : t ? (o = new l.Image, o.onload = c, o.onerror = c, i && (o.sizes = i), s && (o.srcset = s), t && (o.src = t)) : c()
            },
...
class _ {
    constructor(...e) {
        let t, s;
        if (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? s = e[0] : [t, s] = e, s || (s = {}), s = m({}, s), t && !s.el && (s.el = t), s.el && d(s.el).length > 1) {
            const e = [];
        ...
        const i = this;
        i.__swiper__ = !0, i.support = T(), i.device = S({
            userAgent: s.userAgent
        }), i.browser = y(), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], s.modules && Array.isArray(s.modules) && i.modules.push(...s.modules);
        const n = {};
        i.modules.forEach((e => {
            e({
                swiper: i,
        ...
        const a = m({}, G, n);
        return i.params = m({}, a, N, s), i.originalParams = m({}, i.params), i.passedParams = m({}, s), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
            i.on(e, i.params.on[e])
        })), i.params && i.params.onAny && i.onAny(i.params.onAny), i.$ = d, Object.assign(i, {
    ...
    mount(e) {
        ...
        if (0 === a.length && t.params.createElements) {
            ...
            a = d(e), e.className = t.params.wrapperClass, s.append(e), s.children(`.${t.params.slideClass}`).each((e => {
                a.append(e)
            }))
        }
...
function V({
    ...
    function c() {
        ...
        if (e.params.loop ? (p = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), p > n - 1 - 2 * e.loopedSlides && (p -= n - 2 * e.loopedSlides), p > u - 1 && (p -= u), p < 0 && "bullets" !== e.params.paginationType && (p = u + p)) : p = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
            const i = e.pagination.bullets;
            let n, l, u;
            if (s.dynamicBullets && (a = i.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), c.css(e.isHorizontal() ? "width" : "height", a * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (r += p - e.previousIndex, r > s.dynamicMainBullets - 1 ? r = s.dynamicMainBullets - 1 : r < 0 && (r = 0)), n = p - r, l = n + (Math.min(i.length, s.dynamicMainBullets) - 1), u = (l + n) / 2), i.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${s.bulletActiveClass}${e}`)).join(" ")), c.length > 1) i.each((e => {
                const t = d(e),
                    i = t.index();
        ...
        if ("fraction" === s.type && (c.find(j(s.currentClass)).text(s.formatFractionCurrent(p + 1)), c.find(j(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
            let t;
            t = s.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
            const i = (p + 1) / u;
            let n = 1,
                a = 1;
            "horizontal" === t ? n = i : a = i, c.find(j(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${a})`).transition(e.params.speed)
        }
        "custom" === s.type && s.renderCustom ? (c.html(s.renderCustom(e, p + 1, u)), i("paginationRender", c[0])) : i("paginationUpdate", c[0]), e.params.watchOverflow && e.enabled && c[e.isLocked ? "addClass" : "removeClass"](s.lockClass)
    }
    ...
    s("init", (() => {
        ...
        if (e.params.pagination.el && e.params.pagination.hideOnClick && a.length > 0 && !d(n).hasClass(e.params.pagination.bulletClass)) {
...
function W({
    ...
    function r() {
        ...
        t.attr("data-swiper-autoplay") && (s = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), clearTimeout(a), a = p((() => {
            let t;
    ...
    e.autoplay = {
        ...
        if (e.params.autoplay.enabled) {
            l();
            i().addEventListener("visibilitychange", c), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", h), e.$el.on("mouseleave", f))
        }
